<script lang="ts">
    ...
    export let title, description, created_at, tags, is_highlighted;
</script>


{#if is_highlighted}
    <Animated>
        <div class="highlighted flex flex-col gap-10 items-end bg-opacity-70 bg-black rounded-3xl">
...
{:else}
    <Animated delay="400">
        <div class="card_container flex flex-col gap-3 items-end bg-black rounded-3xl">
